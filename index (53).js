...
app.get('/auth/logout', (req, res) => {
  req.logout((err) => {
    ...
    req.session.destroy((err2) => {
      ...
      res.clearCookie('connect.sid', { domain: '.ytsubexchange.online' });
      res.redirect('/');
    });
  });
});
  ...
  try {
    ...
    if (plan === 'membership') {
      ...
      const orderData = {
        ...
        order_meta: {
          return_url: `https://ytsubexchange.online/?paid=membership&order_id={order_id}`,
