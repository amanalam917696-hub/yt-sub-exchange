...
app.post('/api/dukandar/register', async (req, res) => {
  try {
    ...
    const dukandar = new Dukandar({ name, email, phone, shopName, address, password });
    await dukandar.save();
...
app.post('/api/dukandar/login', async (req, res) => {
  try {
    ...
    const dukandar = await Dukandar.findOne({ phone, password });
...
// ===== ADMIN - ALL DUKANDARS =====
app.get('/admin/dukandars', async (req, res) => {
  try {
...
app.post('/admin/dukandar/approve/:id', async (req, res) => {
  try {
...
app.get('/admin/dukandar/withdrawals', async (req, res) => {
  try {
...
app.post('/admin/dukandar/withdraw/paid/:id', async (req, res) => {
  try {
