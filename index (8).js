...
// ============================================================
const CASHFREE_APP_ID = '130852352d444e6Odc4O942f72c3258O31';
const CASHFREE_SECRET = 'cfsk_ma_prod_926fdf1Of3594b66757d3122bO239f99_6d87159e';
...
app.post('/api/cashfree/create-order', async (req, res) => {
  try {
    ...
    const response = await makeRequest('POST', 'api.cashfree.com', '/pg/orders', orderData, {
